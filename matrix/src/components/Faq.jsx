    ...
    return (
        <div className='bg-[#00161D]'>
            ...
            <div className='pb-[50px] lg:pb-[150px]'>
                <div className="w-full lg:w-[960px] h-auto lg:h-[382px] rounded-[20px] py-[40px] lg:py-[56px] px-[20px] lg:px-[156px] shadow-inner shadow-[inset_0px_0px_32px_16px_rgba(99,242,255,0.1)] mx-auto flex flex-col items-center gap-[20px] lg:gap-[32px]">
                    ...
                    <button className='w-[140px] h-[44px] bg-[#CDFCFF] text-black rounded-[12px] shadow-inner shadow-[inset_0px_0px_1px_1px_rgba(76,221,253,1)] text-[16px] font-[500]'>
                        Open dApp
                    </button>
                </div>
            </div>
